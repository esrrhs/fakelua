...
> | **infer.test_spec_*** | **62/23** | 特化路径（Step 17-22: +9） |
...
#### 效果
- `infer.test_infer_*` 55/14 → 64/5（+9 修复，含 degrade_param/float_for 等）
- `infer.test_spec_*` 53/32 → 64/21（+11 修复，含 ternary/wrapper_var/for_bound 等）
