...
TEST(syntax_tree, CompileString) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileString("a = 1", {true})).parse_result.chunk;
...
TEST(syntax_tree, label) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_label.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, assign_simple) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_assign_simple.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, assign) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_assign.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, function_call) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_function_call.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, break) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_break.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, continue) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_continue.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, do_end) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_do_end.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, while) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_while.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, repeat) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_repeat.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, if) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_if.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, string) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_string.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, number) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_number.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, for_num) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_for_num.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, for_in) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_for_in.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, function) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_function.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, var) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_var.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, var_attr) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_var_attr.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, function_call_args) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_function_call_args.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, constructor) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_constructor.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, function_exp) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_function_exp.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, binop) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_binop.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, test_binop_order1) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_binop_order1.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, test_binop_order2) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_binop_order2.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, test_binop_order3) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_binop_order3.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, test_binop_order4) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_binop_order4.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, test_binop_order5) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_binop_order5.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, test_binop_order6) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_binop_order6.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
...
TEST(syntax_tree, test_empty) {
    ...
    Compiler c(s);
    const auto chunk = GetCompileResultImpl(c.CompileFile("./syntax/test_empty.lua", {true})).parse_result.chunk;
    ASSERT_NE(chunk, nullptr);
