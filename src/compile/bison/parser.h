...
#line 135 "parser.h" // lalr1.cc:377
  ...
  basic_symbol (typename Base::kind_type t, const fakelua::SyntaxTreeInterfacePtr v, const location_type& l);
    ...
    , location (other.location)
  {
      switch (other.type_get ())
    {
      ...
      case 85: // fieldlist
      case 86: // field
        value.copy< fakelua::SyntaxTreeInterfacePtr > (other.value);
        break;
    ...
    , location (l)
  {
      ...
      switch (this->type_get ())
    {
      ...
      case 85: // fieldlist
      case 86: // field
        value.copy< fakelua::SyntaxTreeInterfacePtr > (v);
        break;
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const fakelua::SyntaxTreeInterfacePtr v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
      ...
      switch (this->type_get ())
    {
      ...
      case 85: // fieldlist
      case 86: // field
        value.move< fakelua::SyntaxTreeInterfacePtr > (s.value);
        break;
  ...
  parser::symbol_type
  parser::make_FALSES (const location_type& l)
  {
  ...
  parser::symbol_type
  parser::make_VAR_PARAMS (const location_type& l)
  {
  ...
  parser::symbol_type
  parser::make_MORE_EQUAL (const location_type& l)
  {
    return symbol_type (token::TOK_MORE_EQUAL, l);
  }

  parser::symbol_type
  parser::make_LESS_EQUAL (const location_type& l)
  {
  ...
  parser::symbol_type
  parser::make_LEFT_SHIFT (const location_type& l)
  {
    return symbol_type (token::TOK_LEFT_SHIFT, l);
  }

  parser::symbol_type
  parser::make_RIGHT_SHIFT (const location_type& l)
  {
    return symbol_type (token::TOK_RIGHT_SHIFT, l);
  }

  parser::symbol_type
  parser::make_GOTO_TAG (const location_type& l)
  {
  ...
  parser::symbol_type
  parser::make_BITAND (const location_type& l)
  {
    return symbol_type (token::TOK_BITAND, l);
  }

  parser::symbol_type
  parser::make_BITOR (const location_type& l)
  {
    return symbol_type (token::TOK_BITOR, l);
  }

  parser::symbol_type
  parser::make_BITNOT (const location_type& l)
  {
    return symbol_type (token::TOK_BITNOT, l);
  }

  parser::symbol_type
  parser::make_MORE (const location_type& l)
  {
  ...
  parser::symbol_type
  parser::make_NUMBER_SIGN (const location_type& l)
  {
...
#line 1706 "parser.h" // lalr1.cc:377
