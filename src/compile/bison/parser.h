...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_DO = 272,                  // "do"
    TOK_ELSE = 273,                // "else"
    TOK_ELSEIF = 274,              // "elseif"
    TOK_END = 275,                 // "end"
    TOK_FALSES = 276,              // "false"
    TOK_FOR = 277,                 // "for"
    ...
    TOK_NUMBER_SIGN = 313,         // "#"
    TOK_UNARY = 314,               // UNARY
    TOK_IDENTIFIER = 315,          // "identifier"
    TOK_STRING = 316,              // "string"
    TOK_NUMBER = 317               // "number"
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_block = 65,                            // block
        S_stmt = 66,                             // stmt
        S_attnamelist = 67,                      // attnamelist
        S_elseifs = 68,                          // elseifs
        S_retstat = 69,                          // retstat
        S_label = 70,                            // label
        S_funcnamelist = 71,                     // funcnamelist
        S_funcname = 72,                         // funcname
        S_varlist = 73,                          // varlist
        S_var = 74,                              // var
        S_namelist = 75,                         // namelist
        S_explist = 76,                          // explist
        S_exp = 77,                              // exp
        S_prefixexp = 78,                        // prefixexp
        S_functioncall = 79,                     // functioncall
        S_args = 80,                             // args
        S_functiondef = 81,                      // functiondef
        S_funcbody = 82,                         // funcbody
        S_parlist = 83,                          // parlist
        S_tableconstructor = 84,                 // tableconstructor
        S_fieldlist = 85,                        // fieldlist
        S_field = 86,                            // field
        S_fieldsep = 87                          // fieldsep
      };
    };
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, fakelua::SyntaxTreeInterfacePtr&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
