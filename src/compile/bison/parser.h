...
#pragma GCC message "bison: do not #define YYSTYPE in C++, use %define api.value.type"
...
#if 201103L <= YY_CPLUSPLUS
        basic_symbol(typename Base::kind_type t, fakelua::SyntaxTreeInterfacePtr &&v, location_type &&l) : Base(t), value(std::move(v)), location(std::move(l)) {
        }
#else
        basic_symbol(typename Base::kind_type t, const fakelua::SyntaxTreeInterfacePtr &v, const location_type &l) : Base(t), value(v), location(l) {
        }
#endif

#if 201103L <= YY_CPLUSPLUS
        basic_symbol(typename Base::kind_type t, std::string &&v, location_type &&l) : Base(t), value(std::move(v)), location(std::move(l)) {
        }
#else
        basic_symbol(typename Base::kind_type t, const std::string &v, const location_type &l) : Base(t), value(v), location(l) {
        }
#endif
    ...
    struct symbol_type : basic_symbol<by_kind> {
...
#endif
        {
            ...
            YY_ASSERT(tok == token::TOK_YYEOF || (token::TOK_YYerror <= tok && tok <= token::TOK_UNARY));
#endif
        }
#if 201103L <= YY_CPLUSPLUS
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_STAR(location_type l) {
        return symbol_type(token::TOK_STAR, std::move(l));
    }
#else
    static symbol_type make_STAR(const location_type &l) {
        return symbol_type(token::TOK_STAR, l);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_SLASH(location_type l) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_LCURLY(location_type l) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_RCURLY(location_type l) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_LSQUARE(location_type l) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_RSQUARE(location_type l) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_ELSEIF(location_type l) {
        return symbol_type(token::TOK_ELSEIF, std::move(l));
    }
#else
    static symbol_type make_ELSEIF(const location_type &l) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_FALSES(location_type l) {
        return symbol_type(token::TOK_FALSES, std::move(l));
    }
#else
    static symbol_type make_FALSES(const location_type &l) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_LOCAL(location_type l) {
        return symbol_type(token::TOK_LOCAL, std::move(l));
    }
#else
    static symbol_type make_LOCAL(const location_type &l) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_REPEAT(location_type l) {
        return symbol_type(token::TOK_REPEAT, std::move(l));
    }
#else
    static symbol_type make_REPEAT(const location_type &l) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_UNTIL(location_type l) {
        return symbol_type(token::TOK_UNTIL, std::move(l));
    }
#else
    static symbol_type make_UNTIL(const location_type &l) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_GOTO(location_type l) {
        return symbol_type(token::TOK_GOTO, std::move(l));
    }
#else
    static symbol_type make_GOTO(const location_type &l) {
        return symbol_type(token::TOK_GOTO, l);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_DOUBLE_SLASH(location_type l) {
        return symbol_type(token::TOK_DOUBLE_SLASH, std::move(l));
    }
#else
    static symbol_type make_DOUBLE_SLASH(const location_type &l) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_VAR_PARAMS(location_type l) {
        return symbol_type(token::TOK_VAR_PARAMS, std::move(l));
    }
#else
    static symbol_type make_VAR_PARAMS(const location_type &l) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_MORE_EQUAL(location_type l) {
        return symbol_type(token::TOK_MORE_EQUAL, std::move(l));
    }
#else
    static symbol_type make_MORE_EQUAL(const location_type &l) {
        return symbol_type(token::TOK_MORE_EQUAL, l);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_LESS_EQUAL(location_type l) {
        return symbol_type(token::TOK_LESS_EQUAL, std::move(l));
    }
#else
    static symbol_type make_LESS_EQUAL(const location_type &l) {
        return symbol_type(token::TOK_LESS_EQUAL, l);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_NOT_EQUAL(location_type l) {
        return symbol_type(token::TOK_NOT_EQUAL, std::move(l));
    }
#else
    static symbol_type make_NOT_EQUAL(const location_type &l) {
        return symbol_type(token::TOK_NOT_EQUAL, l);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_LEFT_SHIFT(location_type l) {
        return symbol_type(token::TOK_LEFT_SHIFT, std::move(l));
    }
#else
    static symbol_type make_LEFT_SHIFT(const location_type &l) {
        return symbol_type(token::TOK_LEFT_SHIFT, l);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_RIGHT_SHIFT(location_type l) {
        return symbol_type(token::TOK_RIGHT_SHIFT, std::move(l));
    }
#else
    static symbol_type make_RIGHT_SHIFT(const location_type &l) {
        return symbol_type(token::TOK_RIGHT_SHIFT, l);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_GOTO_TAG(location_type l) {
        return symbol_type(token::TOK_GOTO_TAG, std::move(l));
    }
#else
    static symbol_type make_GOTO_TAG(const location_type &l) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_BITAND(location_type l) {
        return symbol_type(token::TOK_BITAND, std::move(l));
    }
#else
    static symbol_type make_BITAND(const location_type &l) {
        return symbol_type(token::TOK_BITAND, l);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_BITOR(location_type l) {
        return symbol_type(token::TOK_BITOR, std::move(l));
    }
#else
    static symbol_type make_BITOR(const location_type &l) {
        return symbol_type(token::TOK_BITOR, l);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_BITNOT(location_type l) {
        return symbol_type(token::TOK_BITNOT, std::move(l));
    }
#else
    static symbol_type make_BITNOT(const location_type &l) {
        return symbol_type(token::TOK_BITNOT, l);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_MORE(location_type l) {
        return symbol_type(token::TOK_MORE, std::move(l));
    }
#else
    static symbol_type make_MORE(const location_type &l) {
        return symbol_type(token::TOK_MORE, l);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_LESS(location_type l) {
        return symbol_type(token::TOK_LESS, std::move(l));
    }
#else
    static symbol_type make_LESS(const location_type &l) {
        return symbol_type(token::TOK_LESS, l);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_NUMBER_SIGN(location_type l) {
        return symbol_type(token::TOK_NUMBER_SIGN, std::move(l));
    }
#else
    static symbol_type make_NUMBER_SIGN(const location_type &l) {
        return symbol_type(token::TOK_NUMBER_SIGN, l);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_UNARY(location_type l) {
        return symbol_type(token::TOK_UNARY, std::move(l));
    }
#else
    static symbol_type make_UNARY(const location_type &l) {
...
#else
    static symbol_type make_IDENTIFIER(const std::string &v, const location_type &l) {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_NUMBER(std::string v, location_type l) {
        return symbol_type(token::TOK_NUMBER, std::move(v), std::move(l));
    }
#else
    static symbol_type make_NUMBER(const std::string &v, const location_type &l) {
